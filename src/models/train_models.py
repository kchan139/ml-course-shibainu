...
class ModelTrainer:
    ...
    @staticmethod
    def gradient_boosting(n_estimators=100, learning_rate=0.1, max_depth=3, 
                          test_size=0.2, random_state=42):
        """Train a gradient boosting model with text data"""
        experiment_id = ModelTrainer._setup_experiment()
    ...
    @staticmethod
    def random_forest(n_estimators=100, max_depth=None, min_samples_split=2,
                      test_size=0.2, random_state=42):
        """Train a random forest model with text data"""
        experiment_id = ModelTrainer._setup_experiment()
